...
# (with turbo mode the tracking overhead of 'load' is negligible)
zinit load Aloxaf/fzf-tab

# Powerlevel10k theme - loaded synchronously (required for instant prompt)
zinit load romkatv/powerlevel10k
# Source p10k config immediately after library is loaded
[[ ! -f ~/.p10k.zsh ]] || source ~/.p10k.zsh

# Oh My Zsh snippets - turbo-loaded
# zinit snippet OMZ::plugins/kubectl/git.plugin.zsh      # kubectl commented out
zinit snippet OMZ::plugins/git/git.plugin.zsh
# zinit snippet OMZ::plugins/aws/aws.plugin.zsh           # aws commented out
# zinit snippet OMZ::plugins/poetry/poetry.plugin.zsh     # poetry commented out
...
# Standalone GitHub repos - turbo-loaded
